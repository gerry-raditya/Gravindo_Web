      ...
      <div className="max-w-7xl mx-auto py-4 lg:py-8 px-4 lg:px-8">
        ...
        <div className="mb-8">
          <div className="flex items-center mb-4">
            ...
            <h1 className="text-2xl lg:text-3xl font-bold text-gray-800">Dashboard Reseller</h1>
          </div>
          <p className="text-gray-600">Kelola aktivitas reseller Anda dengan mudah dan efisien</p>
        </div>
        ...
        <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-xl p-6 mb-8 text-white">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            <div className="mb-4 lg:mb-0">
              ...
              <p className="text-green-100 mb-2">Total Penjualan: {resellerData.currentSales}</p>
              <div className="flex items-center space-x-2">
                <span className="text-sm">Progress ke {resellerData.nextLevel}:</span>
            ...
            <div className="text-right">
              <div className="bg-white/20 rounded-lg p-4">
                ...
                <p className="text-lg font-bold">{resellerData.nextLevelTarget}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            <div className="flex items-center mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Upload Purchase Order Anda</p>
              </div>
            </div>
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center mb-4">
              ...
              <label htmlFor="po-upload" className="cursor-pointer">
                ...
                <p className="text-xs text-gray-500">Format: PDF, DOC, DOCX, JPG, PNG (Max: 10MB)</p>
              </label>
            </div>
            ...
            {uploadStatus && (
              <div className={`p-3 rounded-lg mb-4 ${uploadStatus.includes('berhasil') ? 'bg-green-50 text-green-700' : 'bg-blue-50 text-blue-700'}`}>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            <div className="flex items-center mb-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-800">Download Dokumen</h3>
                <p className="text-sm text-gray-600">Unduh Penawaran & Faktur Pajak</p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              >
                <div className="flex items-center">
                  ...
                  <span className="text-sm font-medium">Download Penawaran</span>
                </div>
              ...
              >
                <div className="flex items-center">
                  ...
                  <span className="text-sm font-medium">Download Faktur Pajak</span>
                </div>
                <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3" />
                </svg>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            <div className="flex items-center mb-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-800">Level & Benefit</h3>
                <p className="text-sm text-gray-600">Cek level dan keuntungan Anda</p>
              </div>
            </div>
            ...
            <div className="mb-4">
              <h4 className="text-sm font-medium text-gray-700 mb-2">Benefit yang Anda dapatkan:</h4>
            ...
            <div className="bg-green-50 rounded-lg p-4">
              <div className="flex justify-between items-center">
                <div>
                  <p className="text-sm font-medium text-green-800">Komisi Bulan Ini</p>
                  <p className="text-lg font-bold text-green-900">{resellerData.monthlyCommission}</p>
                </div>
                <div className="text-right">
                  <p className="text-sm text-green-700">Total Referral</p>
                  <p className="text-xl font-bold text-green-800">{resellerData.totalReferrals}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            <div className="flex items-center mb-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-800">Link Referral</h3>
                <p className="text-sm text-gray-600">Bagikan dan dapatkan komisi</p>
              </div>
            </div>

            <div className="mb-4">
              <label className="text-sm font-medium text-gray-700 block mb-2">Kode Referral Anda</label>
              <div className="flex">
                <input
                  type="text"
                  value={referralCode}
            ...
            <div className="space-y-3">
              <div className="bg-blue-50 rounded-lg p-4">
                <h4 className="text-sm font-medium text-blue-800 mb-2">Cara Mendapatkan Komisi:</h4>
