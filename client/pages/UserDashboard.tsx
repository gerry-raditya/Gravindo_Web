...
const UserDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Main header */}
      <div className="border-b border-gray-200 bg-white h-20 flex items-center px-8">
        <div className="flex items-center space-x-6">
          {/* Tokopedia logo */}
          <div className="flex items-center">
            <svg width="150" height="33" viewBox="0 0 150 34" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <span className="text-sm text-gray-800">Kategori</span>
