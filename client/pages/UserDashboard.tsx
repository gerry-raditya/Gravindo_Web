        ...
        <div className="w-60 bg-white rounded-lg border border-gray-200 h-fit shrink-0 hidden lg:block">
          ...
          <div className="p-4 border-b border-gray-200">
            <div className="flex items-center">
              <img src="https://api.builder.io/api/v1/image/assets/TEMP/91eafe7291a4a72669de3255ed25c9c54dff9025?width=96" alt="User" className="w-12 h-12 rounded-full mr-3" />
          ...
          <div className="p-3 border-b border-gray-200">
            <div className="bg-white border border-gray-300 rounded-lg p-3">
              <img src="https://api.builder.io/api/v1/image/assets/TEMP/72d20354f7b00b60ab8d991365346fca894c98cd?width=92" alt="PLUS" className="w-12 h-4 mb-2" />
              <h4 className="font-bold text-xs mb-1">Nikmatin Gratis Ongkir tanpa batas!</h4>
              <p className="text-xs text-gray-600">Min. belanja Rp0, bebas biaya aplikasi~</p>
            </div>
            ...
            <div className="mt-4 space-y-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <img src="https://api.builder.io/api/v1/image/assets/TEMP/9aebd691e94e299c6779c6ef10e910f2d982b1fd?width=48" alt="GoPay" className="w-6 h-6 mr-2" />
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <img src="https://api.builder.io/api/v1/image/assets/TEMP/65eefc6987a1982201281392aaeecd66bc0397c4?width=48" alt="Card" className="w-6 h-6 mr-2" />
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <img src="https://api.builder.io/api/v1/image/assets/TEMP/985aa3754c43b0519cf760c1232e7f1fd068f245?width=48" alt="Saldo" className="w-6 h-6 mr-2" />
          ...
          <div className="border-b border-gray-200">
            ...
            <div className="space-y-0">
              {['Chat', 'Diskusi Produk', 'Ulasan', 'Pesan Bantuan', 'Pesanan Dikomplain', 'Update'].map((item) => (
                <div key={item} className="px-4 py-2 text-xs hover:bg-gray-50 cursor-pointer border-l-3 border-transparent">
                  {item}
                </div>
              ))}
            </div>
                  ...
                  <div className="border-2 border-green-500 bg-green-50 rounded-lg p-4 relative">
                    ...
                    <div className="pl-4">
                      ...
                      <div className="flex items-center mb-2">
                        ...
                        <span className="bg-gray-200 text-gray-600 px-2 py-1 rounded text-xs font-bold">Utama</span>
                      </div>

                      {/* User info */}
                      <h3 className="font-bold text-sm mb-1">Gerry Raditya Kusmana Yahya</h3>
                      <p className="text-sm text-gray-800 mb-1">62895332274154</p>
                      <p className="text-sm text-gray-800 mb-3">
                        Perum. Pondok Tanah Mas Jl. Kenanga 2 Blok D23 no. 1 Wanasari, Cibitung, Kab bekasi 17520
                      </p>
                      ...
                      <div className="flex items-center mb-4">
                        ...
                        <span className="text-green-600 text-sm font-bold">Sudah Pinpoint</span>
                      </div>

                      {/* Action buttons */}
                      <div className="flex items-center space-x-4 text-green-600">
                        <button className="text-sm font-bold hover:underline">Share</button>
                        <div className="h-4 w-px bg-gray-300"></div>
                        <button className="text-sm font-bold hover:underline">Ubah Alamat</button>
                      </div>
                    </div>
                  </div>
                </div>
