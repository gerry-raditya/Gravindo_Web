                ...
                <div className="space-y-6">
                  ...
                  >
                    <svg className="w-6 h-6" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <mask id="mask0_298_1773" style={{maskType: 'luminance'}} maskUnits="userSpaceOnUse" x="3" y="3" width="19" height="18">
                        <path d="M20.936 10.364H12.55V13.841H17.377C16.927 16.051 15.045 17.318 12.55 17.318C11.8513 17.3193 11.1592 17.1827 10.5134 16.9159C9.86758 16.6491 9.2808 16.2574 8.78672 15.7633C8.29263 15.2692 7.90096 14.6825 7.63417 14.0367C7.36739 13.3909 7.23073 12.6987 7.23205 12C7.23073 11.3013 7.36739 10.6091 7.63417 9.96333C7.90096 9.31753 8.29263 8.73075 8.78672 8.23667C9.2808 7.74258 9.86758 7.35091 10.5134 7.08413C11.1592 6.81734 11.8513 6.68068 12.55 6.682C13.818 6.682 14.964 7.132 15.864 7.868L18.482 5.25C16.886 3.86 14.85 3 12.55 3C7.55005 3 3.55005 7 3.55005 12C3.55005 17 7.55005 21 12.55 21C17.05 21 21.15 17.727 21.15 12C21.1434 11.4488 21.0749 10.9 20.946 10.364H20.936Z" fill="white"/>
                      </mask>
                      <g mask="url(#mask0_298_1773)">
                        <path d="M2.73193 17.3181V6.68213L9.68593 12.0001L2.73193 17.3181Z" fill="#FBBC05"/>
                      </g>
                      <path d="M2.73193 6.68213L9.68593 12.0001L12.5499 9.50513L22.3679 7.90913V2.18213H2.73193V6.68213Z" fill="#EA4335"/>
                      <path d="M2.73193 17.3181L15.0049 7.90009L18.2349 8.30009L22.3669 2.16309V21.8201H2.73193V17.3181Z" fill="#34A853"/>
                      <path d="M22.368 21.8181L9.68605 12.0001L8.05005 10.7731L22.368 6.68311V21.8181Z" fill="#4285F4"/>
                    </svg>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 py-12">
              ...
              <div className="lg:col-span-1">
                ...
                <div className="space-y-3">
                  <div>
                    <p className="text-sm font-medium text-black uppercase">HOTLINE 24/7</p>
                    <p className="text-2xl lg:text-3xl font-bold text-teal-500">(025) 3686 25 16</p>
                  </div>
                  <div className="space-y-2">
              ...
              {/* Categories */}
              <div>
                <h3 className="text-lg font-bold text-black uppercase mb-4">TOP CATEGORIES</h3>
              ...
              {/* Company */}
              <div>
                <h3 className="text-lg font-bold text-black uppercase mb-4">COMPANY</h3>
                <div className="space-y-2 text-sm text-gray-600">
                  <p>About Swoo</p>
                  <p>Contact</p>
                  <p>Career</p>
              ...
              {/* Help Center */}
              <div>
                <h3 className="text-lg font-bold text-black uppercase mb-4">HELP CENTER</h3>
                <div className="space-y-2 text-sm text-gray-600">
              ...
              {/* Partner */}
              <div>
                <h3 className="text-lg font-bold text-black uppercase mb-4">PARTNER</h3>
                <div className="space-y-2 text-sm text-gray-600">
                  <p>Become Seller</p>
                  <p>Affiliate</p>
                  <p>Advertise</p>
            ...
            <div className="border-t border-gray-300 pt-8 pb-8">
              <div className="flex flex-col lg:flex-row justify-between items-center gap-4">
                ...
                <div className="flex items-center space-x-4">
                  <img src="https://api.builder.io/api/v1/image/assets/TEMP/3ec5e0e2b32c6f600b154270564948dfdc75b6eb?width=27" alt="Payment" className="h-4" />
                  <img src="https://api.builder.io/api/v1/image/assets/TEMP/0ca29d9bc5ac440a741b3bc794f9d126f7532591?width=52" alt="Payment" className="h-4" />
                  <img src="https://api.builder.io/api/v1/image/assets/TEMP/b0ce3d300a739c6375cb8c7a91c3e3a7739ac67b?width=81" alt="Payment" className="h-4" />
                  <img src="https://api.builder.io/api/v1/image/assets/TEMP/ac84b11a41bdefeba48c551b63107c43f8bd209a?width=77" alt="Payment" className="h-4" />
                  <img src="https://api.builder.io/api/v1/image/assets/TEMP/9096d579810da22aa89bc38c7591109530ed1f8c?width=143" alt="Payment" className="h-4" />
                </div>
