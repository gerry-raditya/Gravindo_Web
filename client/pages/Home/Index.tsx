  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className="grid grid-cols-4 gap-4">
                {globalState.category.map((category) => (
                  <Link
                    key={category.id}
        ...
        {/* Flash Sale Section */}
        <SectionProduct title="Flash Sale" payload={payload.promo}/>
       

        {/* Popular Products Section */}
        <SectionProduct title="Terlaris Bulan Ini" payload={payload.products.popular}/>

        {/* New Products Section */}
        <SectionProduct title="Produk Terbaru" payload={payload.products.product}/>
